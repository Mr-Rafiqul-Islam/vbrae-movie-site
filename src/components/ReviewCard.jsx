...
function ReviewCard() {
  return (
    <div className="!pt-[13px] md:!pt-[43px] !pb-[15px] md:!pb-[41px] !ps-[15px] md:!ps-[38px] border-gradient">
        ...
        <p className='font-secondary font-normal text-[12px] md:text-[22px] text-white w-[172px] h-auto md:w-[426px] md:h-[64px]'>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
    </div>
  )
}
